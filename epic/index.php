<?php include("../../includes/header.php"); ?>
	<div id="main">	
		...
		<div id="content">		
		<h1>Videregående</h1>		
			<p>På denne side kan der ses hvordan man laver et hurtigere sidste lag på terningen. Dette er også kaldt 4 Look Last Layer (4LLL). Der er også metoder til at løse de første to lag lidt hurtigere.</p>						
		
		<h2>First two Layers (F2L)</h2>
		
		<p>F2L er den del af løsningen der kan vindes mest tid. Samtidig er det er også den del, der er sværest at mestre. Derfor er det en god idé nu allerede at begynde at tænke over placeringen af kant-stykket i forhold til hjørnestykket når man sætter dem ned.</p>
		
		<p>"badmephisto" har lavet en rigtig god F2L video tutorial i to dele på YouTube:</p>
		
		<ul>
			<li><a href="http://www.youtube.com/watch?v=k-xbcAMfWwM">Rubik's Cube: Fridrich F2L explained (PART1/2)</a></li>
			<li><a href="http://www.youtube.com/watch?gl=CA&hl=en&v=4GxLM_dZqg4">Rubik's Cube: Fridrich F2L explained (PART2/2)</a><br /><i>Links sidst tjekket: 2010-04-04</i></li>
		</ul>
		
		<p>Det er endnu ikke så vigtigt at mestre F2L, så jeg råder dig til ikke at lægge for mange kræfter i at forstå hvad videoer viser, bare hav det i baghovedet. Der er stadig meget tid at hente i det sidste lag, når du mestre det, kan du vente tilbage til F2L.</p>

		<p>Tabellen nedenunder indeholder algoritmer tilat placere hjørnerne hurtigere end begyndermetoden. Det vil forbedre dine tider at lære de tre algoritmer og bruge dem til hjørnerne i det første lag.</p>
		...
		<h2>4 Look Last Layer (4LLL)</h2>
		
		<p>Ligesom i begyndermetoden skal der være et kryds i top-laget på ternigen. Herefter vil et af mønstrene illustreret i nedenstående tabel være i top-laget på terningen.</p>
		
		<p>Idenficér mønstret og udfør algoritmen til højre for det. Hvis dette gøres rigtigt skulle alle stykker gerne vende rigtigt.</p>
		...
		<p>Det er vigtigt, at hvis der er "forlygter" på terningen, det vil sige at to hjørner vender således at de har samme farve, skal være på B-siden af terningen. Hvis det ikke er tilfældet, kan ovenstående algoritme udføres en gang hvorpå mønstret vil opstå.</p>
		...
		<p>Når hjørnerne i U-laget er på plads vil en af nedenstående cases være på terningen. Identificér den og udfør algoritmen og terningen er løst.</p>
